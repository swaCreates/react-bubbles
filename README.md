...
- [x] Explain what a token is used for.
    ...
    A token is used to stored some temporary or long lasting data. Dealing 
    with some form of authentication.

- [x] What steps can you take in your web apps to keep your data secure?

    Some steps we can take, are using tokens for authentication as well as private routes which would stop any unauthorized users from seeing specific data, not related to them.

- [x] Describe how web servers work.

    Web servers are a place of storage connected to the internet and can host our web pages, loading our code.    
